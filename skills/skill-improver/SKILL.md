---
name: skill-improver
description: Iteratively reviews and fixes Antigravity skill quality issues until they meet standards. Runs automated fix-review cycles using the skill-reviewer agent. Use to fix skill quality issues, improve skill descriptions, run automated skill review loops, or iteratively refine a...
---

# Skill Improvement Methodology

Iteratively improve a Antigravity skill using the skill-reviewer agent until it meets quality standards.
