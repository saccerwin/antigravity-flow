...
```bash
# Full run
uv run python -m scripts.run ~/.gemini/antigravity/rules/common/testing.md

# Dry run (no cost, spec + scenarios only)
uv run python -m scripts.run --dry-run ~/.gemini/antigravity/skills/search-first/SKILL.md
