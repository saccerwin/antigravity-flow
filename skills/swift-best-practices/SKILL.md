...
## SwiftLens MCP Integration (Antigravity)
...
**Setup for Antigravity CLI:**

Create `.gemini/antigravity/mcps/swiftlens.json` in your Swift project:
...
**⚠️ Note**: This is **Antigravity** configuration (not Antigravity Desktop). See `references/swiftlens-mcp-claude-code.md` for complete setup guide, all 15 tools, index building, and usage examples.
...
- **swiftlens-mcp-claude-code.md** - SwiftLens MCP server setup for Antigravity CLI, 15 semantic analysis tools, index building, usage examples, and integration workflows
