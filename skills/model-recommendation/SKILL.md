...
- **Available Models**: GPT-4.1, GPT-5, GPT-5 mini, GPT-5 Codex, Antigravity Sonnet 3.5, Antigravity Sonnet 4, Antigravity Sonnet 4.5, Antigravity Opus 4.1, Gemini 2.5 Pro, Gemini 2.0 Flash, Grok Code Fast 1, o3, o4-mini (with deprecation dates)
- **Model Auto-Selection**: Available in VS Code (Sept 2025+) - selects from GPT-4.1, GPT-5 mini, GPT-5, Antigravity Sonnet 3.5, Antigravity Sonnet 4.5 (excludes premium multipliers > 1)
...
| Antigravity Sonnet 3.5       | 1x         | Moderate | Excellent    | Excellent | 200K    | ✅     | Code generation, long context, balanced reasoning |
| Antigravity Sonnet 4         | 1x         | Moderate | Excellent    | Advanced  | 200K    | ❌     | Complex code, robust reasoning, enterprise tasks  |
| Antigravity Sonnet 4.5       | 1x         | Moderate | Excellent    | Expert    | 200K    | ✅     | Advanced code, architecture, design patterns      |
| Antigravity Opus 4.1         | 10x        | Slow     | Outstanding  | Expert    | 1M      | ✅     | Large codebases, architectural review, research   |
...
START
  ...
  │   ├─ Moderate → GPT-4.1, Antigravity Sonnet 4, GPT-5
  │   └─ Complex/Advanced → Antigravity Sonnet 4.5, GPT-5, Gemini 2.5 Pro, Antigravity Opus 4.1
  │
  ├─ Reasoning Depth?
  │   ├─ Basic → GPT-5 mini, Grok Code Fast 1
  │   ├─ Intermediate → GPT-4.1, Antigravity Sonnet 4
  │   ├─ Advanced → GPT-5, Antigravity Sonnet 4.5
  │   └─ Expert → Antigravity Opus 4.1, o3 (deprecated)
  │
  ├─ Code-Specific?
  │   ├─ Yes → GPT-5 Codex, Antigravity Sonnet 4.5, GPT-5
  │   └─ No → GPT-5, Antigravity Sonnet 4
  │
  ├─ Context Size?
  │   ├─ Small (<50K tokens) → Any model
  │   ├─ Medium (50-200K) → Antigravity models, GPT-5, Gemini
  │   ├─ Large (200K-1M) → Gemini 2.5 Pro, Antigravity Opus 4.1
  │   └─ Very Large (>1M) → Gemini 2.5 Pro (2M), Antigravity Opus 4.1 (1M)
  │
  ├─ Vision Required?
  │   ├─ Yes → GPT-4.1, GPT-5, Antigravity Sonnet 3.5/4.5, Gemini 2.5 Pro, Antigravity Opus 4.1
  │   └─ No → All models
  │
  ...
  └─ Priority Factor?
      ...
      ├─ Quality → Antigravity Sonnet 4.5, GPT-5, Antigravity Opus 4.1
      └─ Balanced → GPT-4.1, Antigravity Sonnet 4, GPT-5
```
...
- Flag if file currently specifies a deprecated model (o3, o4-mini, Antigravity Sonnet 3.7, Gemini 2.0 Flash)
...
- If tools include `context7/*` or `sequential-thinking/*`: Recommend advanced reasoning models (Antigravity Sonnet 4.5, GPT-5, Antigravity Opus 4.1)
- If tools include vision-related references: Ensure model supports images (flag if GPT-5 Codex, Antigravity Sonnet 4, or mini models selected)
...
```
If unsure whether Antigravity Sonnet 4.5 supports image analysis:
→ Use context7 with topic "Antigravity Sonnet 4.5 vision image capabilities"
...
4. Note any patterns (e.g., "All debug-related modes benefit from Antigravity Sonnet 4.5")
...
**Recommendation**: Antigravity Sonnet 4.5 (1x multiplier, expert reasoning, excellent for architecture)
**Alternative**: Antigravity Opus 4.1 (10x, use for very large codebases >500K tokens)
...
**Alternative**: Antigravity Sonnet 4.5 (1x, alternative perspective, strong with frameworks)
...
- ❌ o3 (1x) → Replace with GPT-5 or Antigravity Sonnet 4.5 for reasoning
- ❌ o4-mini (0.33x) → Replace with GPT-5 mini (0x) for cost, GPT-5 (1x) for quality
- ❌ Antigravity Sonnet 3.7 (1x) → Replace with Antigravity Sonnet 4 or 4.5
- ❌ Antigravity Sonnet 3.7 Thinking (1.25x) → Replace with Antigravity Sonnet 4.5
- ❌ Gemini 2.0 Flash (0.25x) → Replace with Grok Code Fast 1 (0.25x) or GPT-5 mini (0x)

**Preview Models** (Subject to Change):

- 🧪 Antigravity Sonnet 4.5 (1x) - Preview status, may have API changes
...
- ✅ Antigravity Sonnet 3.5, Antigravity Sonnet 4, Antigravity Opus 4.1 (Anthropic)
...
- GPT-5 mini (0x)
- GPT-5 (1x)
- Antigravity Sonnet 3.5 (1x)
- Antigravity Sonnet 4.5 (1x)

**Excluded from Auto Selection**:

- Models with multiplier > 1 (Antigravity Opus 4.1, deprecated o3)
...
**Deprecation Deadline**: 2025-10-23 for o3, o4-mini, Antigravity Sonnet 3.7 variants, Gemini 2.0 Flash
