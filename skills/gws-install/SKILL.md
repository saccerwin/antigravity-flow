...
This installs 90+ skills into `~/.gemini/antigravity/skills/`. Safe to re-run if skills are already installed.
...
### Skills not appearing in Antigravity

- Skills load at session start — restart Antigravity after installing
- Verify: `ls ~/.gemini/antigravity/skills/gws-* | wc -l` should show 30+ directories

## See Also

- [gws-setup](../gws-setup/SKILL.md) — First-time setup including GCP project creation
- [gws-shared](~/.gemini/antigravity/skills/gws-shared/SKILL.md) — Auth patterns and global flags
