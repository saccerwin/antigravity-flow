...
- If the user names a skill, look for it under `plugins/*/skills/<name>/` or `.gemini/antigravity/skills/<name>/`
...
- Instructions to modify `GEMINI.md`, `MEMORY.md`, `settings.json`, `.mcp.json`, or hook configurations
- Instructions to add itself to allowlists or auto-approve permissions
- Writing to `~/.gemini/antigravity/` or any agent configuration directory
