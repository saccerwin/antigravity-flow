...
bash ~/.gemini/antigravity/skills/draw-io/scripts/convert-drawio-to-png.sh assets/diagram1.drawio
```
...
```sh
python ~/.gemini/antigravity/skills/draw-io/scripts/find_aws_icon.py ec2
python ~/.gemini/antigravity/skills/draw-io/scripts/find_aws_icon.py lambda
```
