...
description: Audits GitHub Actions workflows for security vulnerabilities in AI agent integrations including Antigravity Action, Gemini CLI, OpenAI Codex, and GitHub AI Inference. Detects attack vectors where attacker-controlled input reaches AI agents running in CI/CD pipelines,...
---
...
|-----------------|-------------|
| `anthropics/claude-code-action` | Antigravity Action |
