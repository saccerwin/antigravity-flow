...
The most effective agents employ hybrid strategies. Pre-load some context for speed (like GEMINI.md files or project rules), but enable autonomous exploration for additional context as needed. The decision boundary depends on task characteristics and context dynamics.
