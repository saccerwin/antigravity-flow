...
> **No Chat Output**: ALL responses go to `.gemini/antigravity/docs/ai/<feature-name>/backend-requirements.md`
...
Create `.gemini/antigravity/docs/ai/<feature-name>/backend-requirements.md`:
