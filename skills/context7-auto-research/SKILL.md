...
description: "Automatically fetch latest library/framework documentation for Antigravity via Context7 API"
risk: unknown
source: community
...
## Overview
Automatically fetch latest library/framework documentation for Antigravity via Context7 API
