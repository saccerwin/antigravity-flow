...
description: Validates skills in this repo against agentskills.io spec and Antigravity best practices. Use via /validate-skills command.
license: MIT
metadata:
  author: Callstack
...
Validate all skills in `skills/` against the agentskills.io spec and Antigravity best practices.
...
| Concise | Only add context Antigravity doesn't already have |
...
- [Antigravity best practices](https://platform.gemini/antigravity.com/docs/en/agents-and-tools/agent-skills/best-practices)
