...
This skill uses a **playbook** file at `.gemini/antigravity/team-update-playbook.md` in the project root.
...
Check if `.gemini/antigravity/team-update-playbook.md` exists in the project root.
...
After discovery + user preferences, save the playbook to `.gemini/antigravity/team-update-playbook.md`.
...
Ensure `.gemini/antigravity/` is in `.gitignore` (the playbook contains space IDs and preferences that shouldn't be committed).
