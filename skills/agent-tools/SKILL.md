...
| **LLMs** | Antigravity Opus/Sonnet/Haiku, Gemini 3 Pro, Kimi K2, GLM-4, any OpenRouter model |
...
# LLMs (Antigravity, Gemini, Kimi, GLM via OpenRouter)
