...
## Layer 2: Organization (Antigravity / Codex)

Use Antigravity or Codex to:
...
Use Antigravity to analyze transcript + scene timestamps:
```
...
|------|----------|----------|
| Antigravity / Codex | Organization, planning, code generation | Not the creative taste layer |
