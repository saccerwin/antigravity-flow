...
description: >
  kimny × Antigravity（AI）のインタビュー形式でnote記事を作成するスキル。
...
kimnyとAntigravityの対話をインタビュー記事として構成するためのスキル。
...
- **質問者（Antigravity / Hoo）**: `>` 引用ブロックで表示。名前は書かない。
...
*MUEDnote開発者 kimny × Antigravity（AI）*
```
