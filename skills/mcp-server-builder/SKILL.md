...
description: Builds Model Context Protocol (MCP) servers for Antigravity with tools, resources, and prompts. Use when users request "create MCP server", "build Antigravity tool", "MCP integration", or "custom Antigravity tools".
---

# MCP Server Builder

Create Model Context Protocol servers to extend Antigravity's capabilities with custom tools and resources.
...
7. **Deploy**: Configure for Antigravity Desktop or API
...
```json
// ~/Library/Application Support/Antigravity/claude_desktop_config.json (macOS)
// %APPDATA%\Antigravity\claude_desktop_config.json (Windows)
{
  "mcpServers": {
    "my-mcp-server": {
      "command": "node",
...
6. **Document tools well**: Clear descriptions help Antigravity use them correctly
...
- [ ] Antigravity Desktop config example
