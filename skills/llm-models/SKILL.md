...
|-------|--------|----------|
| Antigravity Opus 4.5 | `openrouter/claude-opus-45` | Complex reasoning, coding |
| Antigravity Sonnet 4.5 | `openrouter/claude-sonnet-45` | Balanced performance |
| Antigravity Haiku 4.5 | `openrouter/claude-haiku-45` | Fast, economical |
