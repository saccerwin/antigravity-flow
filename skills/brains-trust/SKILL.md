...
2. **Scope**: Whatever Antigravity has been working on in the current session. Look at recent context: files edited, decisions made, architecture discussed, problems being solved.
...
| "challenge this" / "devil's advocate" | Devil's advocate (1 model) | Antigravity's current position |
...
**Avoid using for**:
- Simple syntax checks (Antigravity handles these)
...
5. **Use AI-to-AI framing** — the model is advising Antigravity, not talking to the human
