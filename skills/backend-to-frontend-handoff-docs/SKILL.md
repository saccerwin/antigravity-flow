...
2. **Create/update handoff file** — write the document to `.gemini/antigravity/docs/ai/<feature-name>/api-handoff.md`. Increment the iteration suffix (`-v2`, `-v3`, …) if rerunning after feedback.
