...
Generate a new Rails project named $1 in the current directory. You may reference @GEMINI.md for general guidance, though the guidance here takes precedence.
