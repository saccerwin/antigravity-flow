...
If `.agents/product-marketing-context.md` exists (or `.antigravity/product-marketing-context.md` in older setups), read it before asking questions. Use that context to skip questions already answered.
