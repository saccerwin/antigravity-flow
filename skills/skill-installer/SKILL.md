...
Remove de `skills/`, `.gemini/antigravity/skills/`, atualiza o registry e remove ZIP do Desktop.
...
Re-registra TODAS as skills em `.gemini/antigravity/skills/`, re-empacota todos os ZIPs,
...
7. **Registrar no Antigravity CLI** - copia SKILL.md para .gemini/antigravity/skills/<nome>/
...
Alem disso, o GEMINI.md global contem instrucao para rodar o instalador automaticamente
