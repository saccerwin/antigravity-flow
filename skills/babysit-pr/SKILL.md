...
6. **Flag ignore candidates** with specific reasoning:
   ...
   - Contradicts project GEMINI.md/AGENTS.md conventions
...
1. **Create plan file** — write to `.gemini/antigravity/scratchpad/pr-{N}-review-plan.md` (create directory if needed)
...
After user approval, re-read `.gemini/antigravity/scratchpad/pr-{N}-review-plan.md` in case it was edited.
...
- "Contradicts project convention (see GEMINI.md) — resolving."
...
2. **Extract owner/repo** — `gh repo view --json owner,name`
3. **Snapshot current state** — write to `.gemini/antigravity/scratchpad/babysit-pr-{N}.md`:
