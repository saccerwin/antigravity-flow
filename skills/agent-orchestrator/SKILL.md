...
1. `.gemini/antigravity/skills/*/` (skills registradas no Antigravity)
...
| registered     | Se esta em .gemini/antigravity/skills/ (true/false)            |
...
4. Copiar o SKILL.md para `.gemini/antigravity/skills/<nome>/SKILL.md`
