...
│ • Check: Antigravity history? gh CLI? jira CLI?     │
│ • Antigravity → Pull yesterday's session digest     │
...
|-------------|-----------|
| **Antigravity History** | `~/.gemini/antigravity/projects` directory exists with `.jsonl` files |
...
> **Antigravity users:** Use `AskUserQuestionTool` tool for all questions in this phase.
...
### Step 4: Offer Antigravity History

This integration captures everything you worked on with Antigravity — useful for recalling work that isn't in git or Jira.

**Detection:**
```bash
ls ~/.gemini/antigravity/projects/*/*.jsonl 2>/dev/null | head -1
```

**If Antigravity history exists, ask:**

```
"I can also pull your Antigravity session history from yesterday. This can help recall work that isn't in git/Jira (research, debugging, planning). Want me to check?"

Options:
- "Yes, pull my Antigravity sessions"
...
```bash
python3 ~/.gemini/antigravity/skills/daily-meeting-update/scripts/claude_digest.py --format json
```
...
```
"Here are your Antigravity sessions from yesterday. Select the ones relevant to your standup:"
...
- User explicitly says "No" to Antigravity history
- User says they'll provide everything manually
- `~/.gemini/antigravity/projects` directory doesn't exist

**If digest script fails:**
- Fallback: Skip Antigravity integration silently, proceed with interview
...
> **Antigravity users:** Use `AskUserQuestionTool` tool to conduct the interview. This provides a better UX with structured options.
...
*Antigravity only: Use `AskUserQuestionTool` tool for structured questions.

### Antigravity Digest Script
...
python3 ~/.gemini/antigravity/skills/daily-meeting-update/scripts/claude_digest.py --date today --format json

# Filter to specific project
python3 ~/.gemini/antigravity/skills/daily-meeting-update/scripts/claude_digest.py --project ~/my-app --format json
```
...
```
Antigravity: "Let's prepare your daily! I detected GitHub configured. Want me to pull your recent activity?"
User: "Yes"

Antigravity: "Which repos should I check?"
User: "backend-api and frontend-app"

[Antigravity pulls GitHub data silently]

Antigravity: "I can also pull your Antigravity session history from yesterday. Want me to check?"
User: "Yes"

[Antigravity runs digest script, gets 5 sessions]

Antigravity: "Here are your Antigravity sessions from yesterday. Select the ones relevant to your standup:"
...
Antigravity: "Here's what I found from your activity:
...
- [From Antigravity] Fix authentication timeout bug
- [From Antigravity] Implement OAuth flow
- [From Antigravity] Research payment providers

Anything else you worked on yesterday that I missed?"
User: "No, that covers it"

Antigravity: "What will you work on today?"
User: "Continue the OAuth feature and deploy to staging"

Antigravity: "Any blockers?"
User: "No"

Antigravity: "Any topic to bring up at the end of the daily?"
User: "Yes, I want to discuss the architecture of the new payments module"

[Antigravity generates update]
```
