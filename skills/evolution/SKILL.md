...
For reliable automatic triggering, use Antigravity hooks. Install with `--with-hooks`:
...
This will install hooks to `.gemini/antigravity/hooks/` and configure `.gemini/antigravity/settings.json`:
    ...
    "UserPromptSubmit": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash .gemini/antigravity/hooks/makepad-skill-router.sh"
          }
        ]
      }
    ],
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash .gemini/antigravity/hooks/pre-tool.sh"
          }
        ]
      }
    ],
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash .gemini/antigravity/hooks/post-bash.sh"
          }
        ]
      }
    ]
