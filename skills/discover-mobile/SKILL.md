...
metadata:
  author: rand
  version: "4.0"
compatibility: Designed for Antigravity. Compatible with any agent supporting the Agent Skills format.
---
...
1. **Auto-activation**: This skill loads automatically when Antigravity detects mobile work
