...
> **Good Skill = Expert-only Knowledge − What Antigravity Already Knows**
...
- **What Antigravity already knows**: Basic concepts, standard library usage, common programming patterns, general best practices

When a Skill explains "what is PDF" or "how to write a for-loop", it's compressing knowledge Antigravity already has. This is **token waste** — context window is a public resource shared with system prompts, conversation history, other Skills, and user requests.
...
Same Antigravity model, different Skills loaded, becomes different experts.
...
|------|------------|-----------|
| **Expert** | Antigravity genuinely doesn't know this | Must keep — this is the Skill's value |
| **Activation** | Antigravity knows but may not think of | Keep if brief — serves as reminder |
| **Redundant** | Antigravity definitely knows this | Should delete — wastes tokens |
...
| Score | Criteria |
|-------|----------|
| 0-5 | Explains basics Antigravity knows (what is X, how to write code, standard library tutorials) |
...
1. For each section, ask: "Does Antigravity already know this?"
2. If explaining something, ask: "Is this explaining TO Antigravity or FOR Antigravity?"
...
The difference between experts and novices isn't "knowing how to operate" — it's "how to think about the problem." But thinking patterns alone aren't enough when Antigravity lacks domain-specific procedural knowledge.

**Key distinction**:
| Type | Example | Value |
|------|---------|-------|
| **Thinking patterns** | "Before designing, ask: What makes this memorable?" | High — shapes decision-making |
| **Domain-specific procedures** | "OOXML workflow: unpack → edit XML → validate → pack" | High — Antigravity may not know this |
| **Generic procedures** | "Step 1: Open file, Step 2: Edit, Step 3: Save" | Low — Antigravity already knows |

| Score | Criteria |
|-------|----------|
| 0-3 | Only generic procedures Antigravity already knows |
| 4-7 | Has domain procedures but lacks thinking frameworks |
| 8-11 | Good balance: thinking patterns + domain-specific workflows |
| 12-15 | Expert-level: shapes thinking AND provides procedures Antigravity wouldn't know |

**What counts as valuable procedures**:
- Workflows Antigravity hasn't been trained on (new tools, proprietary systems)
...
```markdown
### Redlining Workflow (Antigravity wouldn't know this sequence)
...
**The test**:
1. Does it tell Antigravity WHAT to think about? (thinking patterns)
2. Does it tell Antigravity HOW to do things it wouldn't know? (domain procedures)
...
Antigravity hasn't stepped on these landmines. It doesn't know Inter font is overused, doesn't know purple gradients are the signature of AI-generated content. Good Skills must explicitly state these "absolute don'ts."
...
When Antigravity needs to work with professional documents (.docx files) for:
...
- WHEN: "When Antigravity needs to work with... for: (1)... (2)... (3)..."
...
> "Does Antigravity already know this?"

Mark each section as:
- **[E] Expert**: Antigravity genuinely doesn't know this — value-add
- **[A] Activation**: Antigravity knows but brief reminder is useful — acceptable
- **[R] Redundant**: Antigravity definitely knows this — should be deleted
...
Fix: Antigravity already knows this. Delete all basic explanations.
...
│    [ ] Includes domain-specific procedures Antigravity wouldn't know         │
...
If the answer is no → it's compressing what Antigravity already knows.
...
What gets compressed must be things Antigravity doesn't have. Otherwise, it's garbage compression.
...
- **Knowledge Delta**: Provides specific evaluation criteria Antigravity wouldn't generate on its own
