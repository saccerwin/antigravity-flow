...
Intercept the response flow to offer the user a choice about response depth **before** Antigravity answers.
...
Standalone skill from [TBA — Token Budget Advisor for Antigravity](https://github.com/Xabilimon1/Token-Budget-Advisor-Antigravity-Code-).
